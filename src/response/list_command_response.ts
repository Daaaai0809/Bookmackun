...
export const buildListCommandResponse = (content: string, discordUserId: string, embeds: { url: string; description: string }[]): APIInteractionResponseChannelMessageWithSource => {
    return {
