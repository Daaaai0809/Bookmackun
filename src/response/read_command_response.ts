...
export const buildReadCommandResponse = (content: string, discordUserId: string, embeds: { title: string; url: string; }[]): APIInteractionResponseChannelMessageWithSource => {
    return {
